...
/**
 * Customgr enrolment plugin - support for user self unenrolment.
 *
...
$PAGE->set_url('/enrol/customgr/unenrolself.php', array('enrolid'=>$instance->id));
...
$message = get_string('unenrolselfconfirm', 'enrol_customgr', format_string($course->fullname));
