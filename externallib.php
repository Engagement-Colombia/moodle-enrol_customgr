...
/**
 * Customgr enrol plugin external functions
 *
...
/**
 * Customgr enrolment external functions.
 *
 * @package   enrol_customgr
 * @copyright 2024 David Herney @ Engagement
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class enrol_customgr_external extends external_api {
    ...
    public static function get_instance_info_parameters() {
        return new external_function_parameters(
                array('instanceid' => new external_value(PARAM_INT, 'instance id of customgr enrolment plugin.'))
            );
    }
     ...
     *
     * @param int $instanceid instance id of customgr enrolment plugin.
    ...
    public static function enrol_user_parameters() {
        return new external_function_parameters(
            array(
                ...
                'instanceid' => new external_value(PARAM_INT, 'Instance id of customgr enrolment plugin.', VALUE_DEFAULT, 0)
            )
        );
    }
    ...
    public static function enrol_user($courseid, $password = '', $instanceid = 0) {
        ...
        foreach ($instances as $instance) {
            ...
            if ($enrolstatus === true) {
                ...
                $enrol->enrol_customgr($instance, (object) $data);
                $enrolled = true;
                break;
            } else {
                $warnings[] = array(
