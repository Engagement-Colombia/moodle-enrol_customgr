...
/**
 * A bulk operation for the customgr enrolment plugin to delete selected users enrolments.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class enrol_customgr_deleteselectedusers_operation extends enrol_bulk_enrolment_operation {
    ...
    public function get_title() {
        return get_string('deleteselectedusers', 'enrol_customgr');
    }
     ...
     * @return enrol_customgr_deleteselectedusers_form
     */
    public function get_form($defaultaction = null, $defaultcustomdata = null) {
        ...
        $defaultcustomdata['message'] = get_string('confirmbulkdeleteenrolment', 'enrol_customgr');
        $defaultcustomdata['button'] = get_string('unenrolusers', 'enrol_customgr');

        return new enrol_customgr_deleteselectedusers_form($defaultaction, $defaultcustomdata);
    }
    ...
    public function process(course_enrolment_manager $manager, array $users, stdClass $properties) {
        if (!has_capability("enrol/customgr:unenrol", $manager->get_context())) {
            return false;
        }
